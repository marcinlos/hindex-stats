...
def talk_tag():
    ...
    <div class="authors">
        ...
        <a class="person"
        href="person1649.html">
        Jose Monreal Bailey
        </a>
        ,
        <a class="person"
        href="person1650.html">
        Hadi Tabatabaee Malazi
        </a>
        and
        <a class="person"
        href="person1651.html">
        Siobhan Clarke
        </a>
    </div>
    <div class="title">
        ...
        (
        <a href="2021-06-16.html#talk:168617">
        abstract
        </a>
        )
        </span>
...
def test_parsing_author_occurence(author_occurence_tag):
    ...
    expected = parser.AuthorOccurrence("Marco Viceconti", "person2096.html")
...
def test_parsing_talk(talk_tag):
    ...
    expected = parser.Talk(
        ...
        authors=[
            parser.AuthorOccurrence("Jose Monreal Bailey", "person1649.html"),
            parser.AuthorOccurrence("Hadi Tabatabaee Malazi", "person1650.html"),
            parser.AuthorOccurrence("Siobhan Clarke", "person1651.html"),
        ],
    )
    ...
    expected = parser.Session(
        ...
        talks=[
            parser.Talk(
                ...
                authors=[
                    ...
                    parser.AuthorOccurrence(
                        "Hadi Tabatabaee Malazi", "person1650.html"
                    ),
                    parser.AuthorOccurrence("Siobhan Clarke", "person1651.html"),
                ],
            ),
            parser.Talk(
                ...
                authors=[
                    parser.AuthorOccurrence("Khaldoon Dhou", "person1439.html"),
                    parser.AuthorOccurrence("Christopher Cruzen", "person1440.html"),
                ],
            ),
            parser.Talk(
                ...
                authors=[
                    parser.AuthorOccurrence("Tomasz Antczak", "person1301.html"),
                    parser.AuthorOccurrence("Bartosz Skorupa", "person1302.html"),
                    parser.AuthorOccurrence("Mikolaj Szurlej", "person1303.html"),
                    parser.AuthorOccurrence("Rafal Weron", "person1304.html"),
                    parser.AuthorOccurrence("Jacek Zabawa", "person1305.html"),
                ],
            ),
            parser.Talk(
                ...
                authors=[
                    parser.AuthorOccurrence("Krzysztof Małecki", "person905.html"),
                    parser.AuthorOccurrence("Marek Kamiński", "person906.html"),
                    parser.AuthorOccurrence("Jarosław Wąs", "person907.html"),
                ],
            ),
            parser.Talk(
                ...
                authors=[
                    parser.AuthorOccurrence("Zixian Tang", "person910.html"),
                    parser.AuthorOccurrence("Qiang Wang", "person911.html"),
                    parser.AuthorOccurrence("Wenhao Li", "person807.html"),
                    parser.AuthorOccurrence("Huaifeng Bao", "person808.html"),
                    parser.AuthorOccurrence("Wen Wang", "person912.html"),
                    parser.AuthorOccurrence("Feng Liu", "person810.html"),
                ],
            ),
        ],
    )
